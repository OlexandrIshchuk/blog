...
const Home = () => {
	return (
		<>
			...
			<h3 className="my-4">
				Hi to all! This is a platform for posting your blogs. Here you can write about anything you want!
				<Link to="/register"> Register</Link>, create your blog and share your thoughts with others.
			</h3>
			<p>
